...
-  ![Figure 94: size of circle](size of circle.png) \
![Figure 95: color of circle](color of circle.png) 
...
-  ![Figure 98: label format 2](label format 2.png)
...
![Figure 100: final look v5](final look v5.png){width=95%}
...
![Figure 103: exclude null es](exclude null es.png)
...
8. Final look of **visualisation 6**. \
...
![Figure 108: final look v7](final look v7.png)
...
\
![Figure 127: ob - K](ob - K.png){witdth=90%} \
![Figure 128: ob - J](ob - J.png){witdth=90%} \
![Figure 129: ob - S](ob - S.png){witdth=90%} \
